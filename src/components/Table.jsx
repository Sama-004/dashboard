  ...
  return (
    <div>
      ...
      <div className="flex mb-5">
        <div>
          <button className="bg-[#E6E6E6] text-[#808080] px-4 py-2 rounded-3xl mr-4">
            Payouts (22)
          </button>
        </div>
        <div>
          <button className="bg-[#146EB4] text-white px-4 py-2 rounded-3xl mr-4">
            Refunds (6)
          </button>
        </div>
      </div>
          ...
          <div className="flex items-center ">
            <div className="flex items-center cursor-pointer border-2 rounded-sm px-3 py-2 mr-3">
              ...
              <div>
				...
				c3.974,2.985,4.775,8.627,1.79,12.602L171.113,490.698C169.414,492.961,166.749,494.293,163.919,494.293z"></path>
				...
				C357.78,490.264,353.751,494.293,348.78,494.293z"></path>
                </svg>
              </div>
            </div>
